...
public class InstructionManager {
   ...
   private void init(){
      ...
      instructionMap.put(0x07, new RLC(dmgcpu));                                          // RLC A
      instructionMap.put(0x08, new LD_nn_SP(dmgcpu));                                     // LD (nnnn), SP
      instructionMap.put(0x09, new ADD_2R(b, c, dmgcpu));                                 // ADD HL, BC
      ...
      instructionMap.put(0x0F, new RRC(dmgcpu));                                          // RRC A
      ...
      instructionMap.put(0x17, new RL(dmgcpu));                                           // RL A
      instructionMap.put(0x19, new ADD_2R(d, e, dmgcpu));                                 // ADD HL, DE
      ...
      instructionMap.put(0x1F, new RR(dmgcpu));                                           // RR A
      instructionMap.put(0x18, new JR(dmgcpu));                                           // JR nn
      instructionMap.put(0x20, new JR_F(dmgcpu.F_ZERO, (short)0, dmgcpu));                // JR NZ, nn
      instructionMap.put(0x21, new LD_HL(dmgcpu));                                        // LD HL, nnnn
      instructionMap.put(0x22, new LD_HL_A("+", dmgcpu));                                 // LD (HL+), A
      instructionMap.put(0x24, new INC_H_L(0x00FF, 0xFF00, 0x0100, 8, dmgcpu));           // INC H
      instructionMap.put(0x25, new DEC_H_L(0x00FF, 0xFF00, 0x0F00, 0x0100, 8, dmgcpu));   // DEC H
      ...
      instructionMap.put(0x29, new ADD_2R("hl", dmgcpu));                                    // ADD HL, HL
      instructionMap.put(0x2C, new INC_H_L(0xFF00, 0x00FF, 1, 0, dmgcpu));                // INC L
      instructionMap.put(0x2D, new DEC_H_L(0xFF00, 0x00FF, 0x000F, 1, 0, dmgcpu));        // DEC L
      ...
      instructionMap.put(0x31, new LD_SP(dmgcpu));                                        // LD SP, nnnn
      instructionMap.put(0x32, new LD_HL_A("-", dmgcpu));                                 // LD (HL-), A
      instructionMap.put(0x38, new JR_F(dmgcpu.F_CARRY, dmgcpu.F_CARRY, dmgcpu));         // JR C, nn
      instructionMap.put(0x39, new ADD_2R("sp", dmgcpu));                                    // ADD HL, SP
      ...
      instructionMap.put(0xC1, new POP_RR(b, c, dmgcpu));                              // POP BC
      ...
      instructionMap.put(0xC5, new PUSH_RR(b, c, dmgcpu));                             // PUSH BC
      instructionMap.put(0xC6, new ADD(dmgcpu));                                       // ADD A, nn
      ...
      instructionMap.put(0xCE, new ADC(dmgcpu));                                       // ADC A, nn
      ...
      instructionMap.put(0xD1, new POP_RR(d, e, dmgcpu));                              // POP DE
      ...
      instructionMap.put(0xD5, new PUSH_RR(d, e, dmgcpu));                             // PUSH DE
      instructionMap.put(0xD6, new SUB(dmgcpu));                                       // SUB A, nn
