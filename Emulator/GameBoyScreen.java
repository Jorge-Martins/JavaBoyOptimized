...
class GameBoyScreen extends Frame implements ActionListener, ComponentListener, ItemListener {
   ...
   CheckboxMenuItem   soundVolume100;
   CheckboxMenuItem   soundVolume75;
   CheckboxMenuItem   soundVolume50;
   ...
   public GameBoyScreen(String s, JavaBoy a) {
      ...
      soundVolume75 = new CheckboxMenuItem("Volume: 75%");
      soundVolume75.addItemListener(this);

      soundVolume50 = new CheckboxMenuItem("Volume: 50%");
      soundVolume50.addItemListener(this);

      soundVolume25 = new CheckboxMenuItem("Volume: 25%");
      soundVolume25.addItemListener(this);

      soundVolume0 = new CheckboxMenuItem("Volume: 0%");
      soundVolume0.addItemListener(this);
      // <<<<<<<
      ...
      Menu emulationMenu = new Menu("Emulation");
      ...
      soundMenu.add(new MenuItem("-"));
      soundMenu.add(soundVolume100);
      soundMenu.add(soundVolume75);
      soundMenu.add(soundVolume50);
      soundMenu.add(soundVolume25);
      soundMenu.add(soundVolume0);
      soundMenu.add(new MenuItem("-"));
   ...
   public void setVolume(){
      if (applet.dmgcpu != null){
         if(soundVolume100.getState()){
            applet.dmgcpu.soundChip.setVolume(6.0F);
         }
         if(soundVolume75.getState()){
         ...
         for (int r = 0; r < JavaBoy.schemeNames.length; r++) {
            if (JavaBoy.schemeNames[r] == command) {
               applet.dmgcpu.graphicsChip.backgroundPalette.setColours(JavaBoy.schemeColours[r][0],
                        JavaBoy.schemeColours[r][1], JavaBoy.schemeColours[r][2],
                        JavaBoy.schemeColours[r][3]);

               applet.dmgcpu.graphicsChip.obj1Palette.setColours(JavaBoy.schemeColours[r][4],
                        JavaBoy.schemeColours[r][5], JavaBoy.schemeColours[r][6],
                        JavaBoy.schemeColours[r][7]);

               applet.dmgcpu.graphicsChip.obj2Palette.setColours(JavaBoy.schemeColours[r][8],
                        JavaBoy.schemeColours[r][9], JavaBoy.schemeColours[r][10],
                        JavaBoy.schemeColours[r][11]);
   ...
   public void itemStateChanged(ItemEvent e) {
      ...
      if (command.equals("Channel 1 (Square wave)")) {
         ...
         soundVolume50.setState(false);
         soundVolume25.setState(false);
         soundVolume0.setState(false);
         setVolume();
      } else if (command.equals("Volume: 75%")) {
         soundVolume100.setState(false);
         soundVolume75.setState(true);
         soundVolume50.setState(false);
         soundVolume25.setState(false);
         soundVolume0.setState(false);
         setVolume();
      } else if (command.equals("Volume: 50%")) {
         soundVolume100.setState(false);
         soundVolume75.setState(false);
         soundVolume50.setState(true);
         soundVolume25.setState(false);
         soundVolume0.setState(false);
         setVolume();
      } else if (command.equals("Volume: 25%")) {
         soundVolume100.setState(false);
         soundVolume75.setState(false);
         soundVolume50.setState(false);
         soundVolume25.setState(true);
         soundVolume0.setState(false);
         setVolume();
      } else if (command.equals("Volume: 0%")) {
         soundVolume100.setState(false);
         soundVolume75.setState(false);
         soundVolume50.setState(false);
         soundVolume25.setState(false);
         soundVolume0.setState(true);
         setVolume();
         // <<<<<<<<<<<<
